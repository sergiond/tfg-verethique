            ...
            <header className="bg-[#1A1A1A] text-[#F2F0E9] pt-32 pb-24 md:pt-40 md:pb-32 rounded-b-[3rem]">
                <div className="mx-auto max-w-5xl px-6 md:px-8">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <span className="font-mono text-xs uppercase tracking-[0.2em] text-[#CC5833]">Arquitectura del sistema</span>
                    </div>
                    ...
                    <p className="font-sans text-xl md:text-2xl text-[#F2F0E9]/70 max-w-3xl leading-relaxed font-light">
                        Nuestra metodología es independiente, transparente y se basa únicamente en datos públicamente auditables.
                        Creemos que lo que no se puede probar, no se puede afirmar.
                    </p>
                </div>
            </header>

            <main className="mx-auto max-w-5xl px-6 md:px-8 py-20 md:py-32">
                <section className="mb-32 grid md:grid-cols-12 gap-12">
                    <div className="md:col-span-4 flex items-start pt-2">
                        <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-[#1A1A1A]/50">01 - La tesis</h2>
                    </div>
                    <div className="md:col-span-8">
                        ...
                        <div className="flex items-center gap-4 bg-[#1A1A1A] text-[#F2F0E9] p-6 md:p-8 rounded-2xl mt-12">
                            <span className="font-mono text-xl text-[#CC5833]">*</span>
                            <p className="font-mono text-xs md:text-sm uppercase tracking-widest leading-relaxed">
                                Axioma: si no hay evidencia pública, no podemos asumir buenas prácticas.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-32">
                    <div className="grid md:grid-cols-12 gap-12 mb-16">
                        <div className="md:col-span-4 flex items-start">
                            <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-[#1A1A1A]/50">02 - Las dimensiones</h2>
                        </div>
                        <div className="md:col-span-8">
                    ...
                    <div className="grid gap-8">
                        <div className="bg-white rounded-[2rem] p-8 md:p-12 border border-[#D1CFC7]/50 hover:border-[#D1CFC7] transition-colors relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row gap-8 md:gap-16">
                                <div className="md:w-1/3">
                                    ...
                                    <h4 className="font-serif text-3xl text-[#1A1A1A] mb-4">Planeta <span className="italic text-[#1A1A1A]/50">(Ambiental)</span></h4>
                                </div>
                                <div className="md:w-2/3">
                                    ...
                                    <ul className="space-y-4 font-mono text-xs text-[#1A1A1A]/60">
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Integración de prácticas de bajo impacto.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Circularidad y gestión de residuos.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Trazabilidad de materiales y proveedores.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 md:p-12 border border-[#D1CFC7]/50 hover:border-[#D1CFC7] transition-colors relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row gap-8 md:gap-16">
                                <div className="md:w-1/3">
                                    ...
                                    <h4 className="font-serif text-3xl text-[#1A1A1A] mb-4">Personas <span className="italic text-[#1A1A1A]/50">(Laboral)</span></h4>
                                </div>
                                <div className="md:w-2/3">
                                    <p className="font-sans text-lg text-[#1A1A1A]/70 leading-relaxed max-w-xl mb-8">
                                    ...
                                    <ul className="space-y-4 font-mono text-xs text-[#1A1A1A]/60">
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Condiciones de trabajo y seguridad.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Prácticas de contratación y cumplimiento básico.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Evidencia de protocolos sociales aplicados.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 md:p-12 border border-[#D1CFC7]/50 hover:border-[#D1CFC7] transition-colors relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                                <ShieldCheck className="w-32 h-32 text-[#CC5833]" />
                            </div>
                            <div className="relative z-10 flex flex-col md:flex-row gap-8 md:gap-16">
                                <div className="md:w-1/3">
                                    <span className="inline-block px-3 py-1 font-mono text-[10px] uppercase tracking-widest border border-[#CC5833]/30 rounded-full text-[#CC5833] mb-6 font-bold">Dimensión 03</span>
                                    <h4 className="font-serif text-3xl text-[#1A1A1A] mb-4">Gobernanza <span className="italic text-[#1A1A1A]/50">(Transparencia)</span></h4>
                                </div>
                                <div className="md:w-2/3">
                                    <p className="font-sans text-lg text-[#1A1A1A]/70 leading-relaxed max-w-xl mb-8">
                                    ...
                                    <ul className="space-y-4 font-mono text-xs text-[#1A1A1A]/60">
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Claridad documental y trazabilidad.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Coherencia entre comunicación y práctica real.</li>
                                        <li className="flex items-start gap-4"><span className="text-[#CC5833] mt-0.5">↳</span> Actualización y mantenimiento de evidencias.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <section className="mb-32">
                    <div className="grid md:grid-cols-12 gap-12 mb-16">
                        <div className="md:col-span-4 flex items-start">
                            <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-[#1A1A1A]/50">03 - Resultados de datos</h2>
                        </div>
                        <div className="md:col-span-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#D1CFC7] border border-[#D1CFC7] overflow-hidden rounded-[2rem]">
                        <div className="bg-[#white] p-10 flex flex-col">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="font-mono text-[10px] text-[#1A1A1A]/40 uppercase tracking-widest mt-1">Líder de sistemas</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-[#white] p-10 flex flex-col">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="font-mono text-[10px] text-[#1A1A1A]/40 uppercase tracking-widest mt-1">Progreso sustancial</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-[#white] p-10 flex flex-col">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="font-mono text-[10px] text-[#1A1A1A]/40 uppercase tracking-widest mt-1">Inicio básico</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-[#white] p-10 flex flex-col">
                            <div className="flex items-center gap-4 mb-8">
                                <span className="font-serif text-5xl text-[#1A1A1A]/40">1-2.</span>
                                <div>
                                    ...
                                    <p className="font-mono text-[10px] text-[#1A1A1A]/40 uppercase tracking-widest mt-1">Práctica insuficiente</p>
                                </div>
                            </div>
                ...
                <div className="bg-[#1A1A1A] p-12 md:p-16 rounded-[2rem] text-center border border-white/10 relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <Database className="w-8 h-8 text-[#CC5833] mb-6" />
                        ...
                        <Link
                            href="/contacto"
                            className="inline-flex relative items-center justify-center px-6 py-2.5 rounded-full text-xs font-bold uppercase tracking-widest transition-all duration-500 overflow-hidden group border border-background/80 text-background hover:bg-[#F2F0E9] hover:text-[#1A1A1A]"
                        >
